...
#pub fun produce_bridge(b: !$B.builder_v >> $B.builder_v): void

#pub fun produce_bridge_app {nw:nat}{nr:nat}
  (b: !$B.builder_v >> $B.builder_v, wasm_name: string nw, root_id: string nr): void

#pub fun produce_service_worker {nw:nat}
  (b: !$B.builder_v >> $B.builder_v, wasm_name: string nw): void
