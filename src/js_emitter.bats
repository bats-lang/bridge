...
#pub fun emit_js_all(b: !$B.builder_v >> $B.builder_v): void

fun bput_loop {sn:nat}{i:nat | i <= sn}{fuel:nat} .<fuel>.
  (b: !$B.builder_v >> $B.builder_v, s: string sn, slen: int sn, i: int i, fuel: int fuel): void =
  if fuel <= 0 then ()
  else if i >= slen then ()
  else let
...
fn emit_js_header(b: !$B.builder_v >> $B.builder_v): void = let
...
fn emit_js_loadwasm_open(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
  val () = bput(b, "/**\n")
...
fn emit_js_dom(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
...
fn emit_js_timer(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
  val () = bput(b, "  // --- Timer ---\n")
  val () = bput(b, "\n")
...
fn emit_js_idb(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
...
fn emit_js_window(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
  val () = bput(b, "  // --- Window ---\n")
  val () = bput(b, "\n")
...
fn emit_js_nav(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
...
fn emit_js_dom_read(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
  val () = bput(b, "  // --- DOM read ---\n")
  val () = bput(b, "\n")
...
fn emit_js_event(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
...
fn emit_js_fetch(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
  val () = bput(b, "  // --- Fetch ---\n")
  val () = bput(b, "\n")
...
fn emit_js_clipboard(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
...
fn emit_js_file(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
  val () = bput(b, "  // --- File ---\n")
  val () = bput(b, "\n")
...
fn emit_js_decompress(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
...
fn emit_js_notify(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
...
fn emit_js_xml(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
...
fn emit_js_blob(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
...
fn emit_js_media(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
...
fn emit_js_scroll(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
  val () = bput(b, "  // --- Scroll ---\n")
  val () = bput(b, "\n")
...
fn emit_js_imports(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
...
fn emit_js_loadwasm_close(b: !$B.builder_v >> $B.builder_v): void = let
  val () = bput(b, "\n")
